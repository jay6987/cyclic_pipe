...
/// The main module of the crate.
pub mod cyclic_pipe;

pub use cyclic_pipe::builder::Builder;
pub use cyclic_pipe::consumer::Consumer;
pub use cyclic_pipe::producer::Producer;
pub use cyclic_pipe::token::Token;
